...
-- Purpose: Process access logs with PL/SQL logic (Grouped Output)
SET SERVEROUTPUT ON;
DECLARE
...
BEGIN
    ...
    DBMS_OUTPUT.PUT_LINE('⚠️ FAILED ACCESS ATTEMPTS:');
    ...
    DBMS_OUTPUT.PUT_LINE(CHR(10) || '✅ SUCCESSFUL ACCESS ATTEMPTS:');
    FOR i IN 1 .. attempts.COUNT LOOP
    ...
    DBMS_OUTPUT.PUT_LINE(CHR(10) || '🎯 Processing complete using collections, records, and GOTO.');
END;
/
